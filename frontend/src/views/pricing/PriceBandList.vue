...
import type { PriceBand, PriceBandFilters, PriceBandCreateRequest, PriceBandUpdateRequest } from '@/types/price-band'
...
const handleSubmit = async () => {
  try {
    ...
    if (dialog.isEdit && dialog.currentId) {
      await priceBandApi.update(dialog.currentId, formData.value as PriceBandUpdateRequest)
